"""
nur Attested Data Transformation Chain (ADTC)
=================================================
...
In nur ADTC, you attest that DATA TRANSFORMATIONS were correctly
...
THE PROTOCOL
------------
Like DICE (Device Identifier Composition Engine), each step in the nur
...
USAGE
-----
    from nur.attest import attest_pipeline, verify_chain
